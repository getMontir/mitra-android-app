 ...
 */
package com.getmontir.lib.presentation.component.pin

import com.getmontir.lib.presentation.component.pin.DefaultMovementMethod.Companion.getInstance
...
class PinView @JvmOverloads constructor(
    ...
    private var mHighlightLineWhenFilled: Boolean
    ...
    private fun drawPinView(canvas: Canvas) {
        ...
        for (i in 0 until mPinItemCount) {
            ...
            mPaint.color =
                if (highlight || (mHighlightLineWhenFilled && i < highlightIdx) ) getLineColorForState(*HIGHLIGHT_STATES) else currentLineColor
            updateItemRectF(i)
            updateCenterPoint()
            canvas.save()
